...
def upgrade():
    ...
    op.add_column('account_user', sa.Column('username', sa.String(length=16), nullable=False, comment='用户名'))
    op.create_unique_constraint(op.f('uq_account_user_username'), 'account_user', ['username'])
